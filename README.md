...
[`matryoshka`](./matryoshka/): Dump of experiments in MRL training that went
nowhere.

[`precision_drop.ipynb`](./precision_drop.ipynb): An answer to: why did precision drop
in production?
...
[`sigltt/train.ipynb`](./sigltt/train.ipynb) and https://github.com/kddubey/mpnrl.
