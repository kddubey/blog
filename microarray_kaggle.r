# (This is code from a school project in 2020 I think.)

# See https://www.kaggle.com/kdubey/sparse-linear-svm-is-accurate-and-interpretable for
# a full write-up and code.
